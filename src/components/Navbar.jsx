                ...
                <div className="row justify-content-between align-items-center">
                    <div className="col-auto">
                        ...
                        <a href="index.html" className="header-logo">
                            <img className="img-fluid" src={"assets/images/logo/logo-light-theme.png"} aria-hidden alt=""/>
                        </a>
                        {/* <!-- End Header Logo --> */}
                    ...
                    <div className="col-auto d-flex align-items-center">
                        <div className="header-event">
                            ...
                            <div className="search-event">
                                ...
                                <button className="header-search-btn" type="submit"><img src={"assets/images/icons/icon-search.svg"} aria-hidden alt=""/></button>
                            </div>
                            {/* <!-- End Menu event --> */}
                        </div>
                    </div>
                    ...
                    <div className="col-auto">
                        <div className="header-action">
                            <button className="header-action-item header-action-wishlist" data-bs-toggle="offcanvas" data-bs-target="/#wishlistOffcanvas"><img src={"assets/images/icons/icon-heart-dark.svg"} aria-hidden alt=""/><span className="count-tag">01</span></button>
                            <button className="header-action-item header-action-wishlist" data-bs-toggle="offcanvas" data-bs-target="/#addcartOffcanvas"><img src={"assets/images/icons/icon-shopping-bag-dark.svg"} aria-hidden alt=""/><span className="item-count item-count--light">02 ITEMS</span></button>
                        </div>
                    </div>
    ...
    <div className="offcanvas offcanvas-start" tabIndex="-1" id="toggleMenu">
        ...
        <div className="offcanvas-body">
            <div className="d-flex justify-content-center ">
                <a href="wishlist.html" className="header-action-item header-action-wishlist"><img src={"assets/images/icons/icon-heart-dark.svg"} aria-hidden alt=""/><span className="count-tag">01</span></a>
                <a href="cart.html" className="header-action-item header-action-wishlist"><img src={"assets/images/icons/icon-shopping-bag-dark.svg"} aria-hidden alt=""/><span className="item-count item-count--light">02 ITEMS</span></a>
            </div>
            ...
            <div className="offcanvas-mobile-menu-wrapper">
                ...
                <div className="mobile-contact-info text-center">
                    <ul className="social-link">
                        <li><a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer"><img className="icon-svg" src="assets/images/icons/icon-facebook-f-dark.svg"  alt=""/></a>
                        </li>
                        <li><a href="https://twitter.com/" target="_blank" rel="noopener noreferrer"><img className="icon-svg" src="assets/images/icons/icon-twitter-dark.svg"  alt=""/> </a>
                        </li>
                        <li><a href="https://www.pinterest.com/" target="_blank" rel="noopener noreferrer"><img className="icon-svg" src="assets/images/icons/icon-pinterest-p-dark.svg" alt=""/></a></li>
                        <li><a href="https://dribbble.com/" target="_blank" rel="noopener noreferrer"><img className="icon-svg" src="assets/images/icons/icon-dribbble-dark.svg"  alt=""/></a></li>
                    </ul>
                </div>
        ...
        <div className="offcanvas-body">
            <ul className="offcanvas-products-list">
                <li className="single-item">
                    <div className="box">
                        <a href="/#" className="image">
                            <img src={"assets/images/products/small/product-small-1.webp"} aria-hidden alt="" className="offcanvas-wishlist-image"/>
                        </a>
                ...
                <li className="single-item">
                    <div className="box">
                        <a href="/#" className="image">
                            <img src={"assets/images/products/small/product-small-2.webp"} aria-hidden alt="" className="offcanvas-wishlist-image"/>
                        </a>
                        <div className="content">
                ...
                <li className="single-item">
                    <div className="box">
                        <a href="/#" className="image">
                            <img src={"assets/images/products/small/product-small-3.webp"} aria-hidden alt="" className="offcanvas-wishlist-image"/>
                        </a>
                        <div className="content">
...
export  function ColorNav() {
    return (
        <div>
            
            
                        {/* <!-- .....:::::: Start Header Section - Light Header :::::.... --> */}
    <header className="header-section pos-absolute pos-relative light-bg sticky-header d-none d-lg-block section-fluid-270">
        <div className="header-wrapper pos-relative">
            <div className="container-fluid">
                <div className="row justify-content-between align-items-center">
                    <div className="col-auto">
    ...
    {/* <!-- .....:::::: End Header Section - Light Header :::::.... --></div> */}
