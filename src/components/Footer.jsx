            ...
            <div className="footer-wrapper section-fluid-270">
                <div className="container-fluid">
                    ...
                    <div className="footer-top">
                        ...
                        <div className="footer-top-right">
                            <div className="footer-social">
                                <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer"><img className="icon-svg" src="assets/images/icons/icon-facebook-f-dark.svg" alt=""/></a>
                                <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer"><img className="icon-svg" src="assets/images/icons/icon-twitter-dark.svg" alt=""/></a>
                                <a href="https://www.pinterest.com/" target="_blank" rel="noopener noreferrer"><img className="icon-svg" src="assets/images/icons/icon-pinterest-p-dark.svg" alt=""/></a>
                                <a href="https://dribbble.com/" target="_blank" rel="noopener noreferrer"><img className="icon-svg" src="assets/images/icons/icon-dribbble-dark.svg" alt=""/></a>
                            </div>
                        </div>
                    </div>
                    {/* <!-- End Footer Top  -->
                    ...
                    <div className="footer-bottom">
                        <p className="copyright-text copyright-text--light">&copy; 2021 Mart Up. Made with <span className="material-icons">favorite</span> by <a href="https://hasthemes.com/" target="_blank" rel="noopener noreferrer">Codecarnival</a></p>
