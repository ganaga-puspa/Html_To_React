                        ...
                        <div className="row justify-content-between mb-n40">
                            <div className="col-xl-4 col-md-6 col-12 mb-40">
                                ...
                                <div className="shipping-single-item--style-1">
                                    <div className="icon">
                                        <img className="img-fluid" src={"assets/images/icons/shipping-icon-1.svg"} width="46" height="33" loading="lazy" aria-hidden alt="shipping-icon-1"/>
                                    </div>
                            ...
                            <div className="col-xl-4 col-md-6 col-12 mb-40">
                                ...
                                <div className="shipping-single-item--style-1">
                                    <div className="icon">
                                        <img className="img-fluid" src={"assets/images/icons/shipping-icon-2.svg"} width="46" height="33" loading="lazy" aria-hidden alt="shipping-icon-2"/>
                                    </div>
                                    <div className="content">
                            ...
                            <div className="col-xl-4 col-md-6 col-12 mb-40">
                                ...
                                <div className="shipping-single-item--style-1">
                                    <div className="icon">
                                        <img className="img-fluid" src={"assets/images/icons/shipping-icon-3.svg"} width="46" height="33" loading="lazy" aria-hidden alt="shipping-icon-3"/>
                                    </div>
                                    <div className="content">
